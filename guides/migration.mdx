...
|---------|--------|---------------|-------------|
| 5.x | Current | Full support (new features, bug fixes, security) | See [releases](https://github.com/bluelibs/runner/releases) |
| 4.x | Maintenance | Critical fixes and security only | See [releases](https://github.com/bluelibs/runner/releases) |
